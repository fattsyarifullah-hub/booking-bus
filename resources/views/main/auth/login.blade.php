...
@section('content')
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-violet-700 p-15 rounded-2xl pt-7">
            ...
            <p class="pt-3 flex justify-center text-sm font-sans text-violet-200 gap-1">belum punya akun? <a href="/register" class="italic text-white font-medium">daftar di sini !</a></p>
        </div>
    </div>
@endsection
