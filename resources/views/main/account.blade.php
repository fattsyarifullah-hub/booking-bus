...
<div class="min-h-screen bg-gray-50 py-10 px-4 md:px-8">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-violet-700 rounded-2xl p-6 md:p-8 text-white shadow-lg mb-8 flex items-center justify-between">
            <div>
                <span class="text-violet-200 text-xs font-bold uppercase tracking-widest block mb-1">Selamat Datang Kembali</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @forelse ($user->buses as $bus)
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 flex flex-col sm:flex-row items-center justify-between gap-5 transition hover:shadow-md">
                    ...
                    <div class="w-full flex-grow space-y-2">
                        ...
                        <div class="pt-2 border-t border-gray-100/70">
                            <span class="text-[10px] uppercase font-bold text-gray-400 block">Jadwal Keberangkatan</span>
                    ...
                    <div class="flex flex-col items-center justify-center p-3 bg-gray-50 border border-gray-100 rounded-xl w-36 shrink-0">
                        <img src="{{ $qrCode }}" alt="QR Code Tiket" class="w-28 h-28 object-contain bg-white p-1 rounded-md shadow-inner">
                        <span class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-2">Scan Tiket</span>
                    </div>
            ...
            @empty
                <div class="col-span-1 md:col-span-2 bg-white rounded-2xl p-12 text-center border border-gray-100 shadow-sm">
                    ...
                    <p class="text-xs text-gray-400 mt-1">Tiket perjalanan bus yang kamu pesan nantinya akan muncul di sini.</p>
                </div>
            @endforelse
        </div>
